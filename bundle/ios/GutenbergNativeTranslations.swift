...
private func dummy() {
    ...
    _ = NSLocalizedString("%d blocks", comment: "translators: %d: number of blocks.")
    ...
    _ = NSLocalizedString("Convert to Regular Block", comment: "")
    _ = NSLocalizedString("Copied %d blocks to clipboard.", comment: "Translators: Number of blocks being copied")
    ...
    _ = NSLocalizedString("Moved %d blocks to clipboard.", comment: "Translators: Number of blocks being cut")
