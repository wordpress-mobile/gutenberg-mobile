...
private func dummy() {
    ...
    _ = NSLocalizedString("Each block has its own settings. To find them, click on a block. Its settings will appear on the toolbar at the bottom of the screen.", comment: "")
    ...
    _ = NSLocalizedString("Embed previews not yet available", comment: "")
    ...
    _ = NSLocalizedString("We’re working hard on adding support for embed previews. In the meantime, you can preview the embedded content on the page.", comment: "")
    _ = NSLocalizedString("We’re working hard on adding support for embed previews. In the meantime, you can preview the embedded content on the post.", comment: "")
