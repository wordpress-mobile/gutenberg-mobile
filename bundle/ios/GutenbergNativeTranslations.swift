...
private func dummy() {
    ...
    _ = NSLocalizedString("Access this Paywall block on your web browser for advanced settings.", comment: "")
    ...
    _ = NSLocalizedString("Block grouped", comment: "translators: displayed right after the block is grouped")
    ...
    _ = NSLocalizedString("Block ungrouped", comment: "translators: displayed right after the block is ungrouped.")
    ...
    _ = NSLocalizedString("Blocks nested deeper than %d levels may not render properly in the mobile editor.", comment: "translators: Warning related to having blocks deeply nested. %d: The deepest nesting level.")
    ...
    _ = NSLocalizedString("Button to copy error details", comment: "")
    _ = NSLocalizedString("Button to copy post text", comment: "")
    ...
    _ = NSLocalizedString("Copy error details", comment: "")
    ...
    _ = NSLocalizedString("Tap here to copy error details", comment: "")
    ...
    _ = NSLocalizedString("Waiting for connection", comment: "")
    ...
    _ = NSLocalizedString("You can copy your post text in case your content is impacted. Copy error details to debug and share with support.", comment: "")
