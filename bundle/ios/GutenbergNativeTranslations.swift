...
private func dummy() {
    ...
    _ = NSLocalizedString("Add", comment: "")
    ...
    _ = NSLocalizedString("Characters", comment: "")
    ...
    _ = NSLocalizedString("Close block inspector sidebar", comment: "")
    ...
    _ = NSLocalizedString("Details", comment: "translators: button label text should, if possible, be under 16 characters.")
    ...
    _ = NSLocalizedString("Hide More Settings", comment: "")
    ...
    _ = NSLocalizedString("Linear", comment: "")
    _ = NSLocalizedString("Link To", comment: "")
    _ = NSLocalizedString("Modes", comment: "")
    ...
    _ = NSLocalizedString("Radial", comment: "")
    ...
    _ = NSLocalizedString("Show button text labels", comment: "")
    _ = NSLocalizedString("Show More Settings", comment: "")
