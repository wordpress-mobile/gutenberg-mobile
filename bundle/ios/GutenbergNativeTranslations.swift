...
private func dummy() {
    ...
    _ = NSLocalizedString("%s Settings", comment: "translators: %s: block title e.g: \"Paragraph\".")
    ...
    _ = NSLocalizedString("Move %s Down", comment: "translators: %s: block title e.g: \"Paragraph\"")
    _ = NSLocalizedString("Move %s Left", comment: "translators: %s: block title e.g: \"Paragraph\"")
    _ = NSLocalizedString("Move %s Right", comment: "translators: %s: block title e.g: \"Paragraph\"")
    _ = NSLocalizedString("Move %s Up", comment: "translators: %s: block title e.g: \"Paragraph\"")
    ...
    _ = NSLocalizedString("Remove %s", comment: "translators: %s: block title e.g: \"Paragraph\".")
    ...
    _ = NSLocalizedString("Save the menu currently being edited.", comment: "")
