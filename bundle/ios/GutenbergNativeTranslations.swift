...
private func dummy() {
    ...
    _ = NSLocalizedString("''%s' converted to regular blocks", comment: "translators: Convert to regular blocks notice message. %s: The reusable block name")
    ...
    _ = NSLocalizedString("Changes made to %s discarded", comment: "translators: Changes discarded notice message. %s: The reusable block name")
    _ = NSLocalizedString("Changes made to %s saved", comment: "translators: Changes saved notice message. %s: The reusable block name")
    ...
    _ = NSLocalizedString("Reusable block settings", comment: "")
    ...
    _ = NSLocalizedString("Unsaved changes", comment: "translators: Unsaved changes alert title.")
    _ = NSLocalizedString("Unsupported", comment: "")
    _ = NSLocalizedString("Updates the title.", comment: "")
    _ = NSLocalizedString("Updates to block name are applied when changes to the block are saved", comment: "")
    ...
    _ = NSLocalizedString("Would you like to save or discard the changes made to %s?", comment: "translators: Unsaved changes alert message. %s: The reusable block name")
