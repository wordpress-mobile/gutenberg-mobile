export const NESTED_COLUMNS_CASE_1 = `
...
<!-- wp:cover {"url":"https://cldup.com/cXyG__fTLN.jpg","id":2067,"align":"full"} -->
<div class="wp-block-cover alignfull has-background-dim" style="background-image:url(https://cldup.com/cXyG__fTLN.jpg)"><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…"} -->
<p class="has-text-align-center"></p>
...
<figure class="wp-block-image size-large"><img src="https://cldup.com/cXyG__fTLN.jpg" alt="" class="wp-image-2059"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-large"><img src="https://cldup.com/cXyG__fTLN.jpg" alt="" class="wp-image-2063"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-large"><img src="https://cldup.com/cXyG__fTLN.jpg" alt="" class="wp-image-2061"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
`;

export const NESTED_COLUMNS_CASE_2 = `<!-- wp:separator {"opacity":"css"} -->
<hr class="wp-block-separator has-css-opacity"/>
<!-- /wp:separator -->

<!-- wp:heading -->
<h2 class="wp-block-heading">Full width - equal columns widths</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Full width - equal columns widths &lt; 100 %</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Full width - different <strong>columns widt</strong>hs &gt; 100%</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Full width - one column &lt; 100%</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Full width - nesting columns, equal widths</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Full width - nesting columns, widths &lt; 100%</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Wide width - equal columns widths</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Wide width - equal columns widths &lt; 100 %</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Wide width - different <strong>columns widt</strong>hs &gt; 100%</h2>
<!-- /wp:heading -->
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Wide width - one column &lt; 100%</h2>
<!-- /wp:heading -->
