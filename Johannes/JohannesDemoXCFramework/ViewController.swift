import Aztec
import Johannes // This will eventually be import Gutenberg
import UIKit
...
class ViewController: UIViewController {
    ...
    // FIXME: Skipping CustomImageLoader for the moment because it accesses RCTImage* types which the compiler can't find
...
extension ViewController: GutenbergWebDelegate {
...
extension ViewController: GutenbergBridgeDataSource {
