...
# 2. Flatten embedded frameworks for every framework in the archives
flattenFrameworks $PLATFORM_IOS
flattenFrameworks $PLATFORM_SIMULATOR
...
cp -r "$XCFRAMEWORKS_DIR/hermes.xcframework" "$ARCHIVE_FRAMEWORKS_PATH"
